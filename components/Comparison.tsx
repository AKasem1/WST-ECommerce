...
const comparisonData = [
  {
    ...
    features: [
      ...
      { name: 'تعريف المخازن', cashier: false, merchant: false, enterprise: true },
      ...
      { name: 'العيارات', cashier: false, merchant: true, enterprise: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'فاتورة خدمات', cashier: false, merchant: false, enterprise: true },
      { name: 'انتاج', cashier: false, merchant: false, enterprise: true },
  ...
  },
  {
    category: 'المخازن',
    features: [
      { name: 'مطابقة الجرد', cashier: false, merchant: true, enterprise: true },
      { name: 'وارد مخزني', cashier: false, merchant: true, enterprise: true },
      { name: 'صرف مخزني', cashier: false, merchant: true, enterprise: true },
      { name: 'كشف جرد المخازن', cashier: false, merchant: true, enterprise: true },
      { name: 'ارصدة المخزن حتى تاريخ', cashier: false, merchant: true, enterprise: true },
      { name: 'حركة صنف محددة', cashier: true, merchant: true, enterprise: true },
      { name: 'صنف باجمالي الحركات', cashier: false, merchant: true, enterprise: true },
  ...
  },
  {
    category: 'الحسابات',
    features: [
      { name: 'شجرة الحسابات', cashier: false, merchant: false, enterprise: true },
      { name: 'القيود اليومية والإفتتاحية', cashier: false, merchant: false, enterprise: true },
      { name: 'كشف حساب', cashier: false, merchant: false, enterprise: true },
      { name: 'ميزان مراجعة رئيسي وتحليلي', cashier: false, merchant: false, enterprise: true },
      { name: 'ارباح وخسائر حسابات رئيسية وتحليلية', cashier: false, merchant: false, enterprise: true },
      { name: 'ميزان عمومية حسابات رئيسية وتحليلية', cashier: false, merchant: false, enterprise: true },
      { name: 'إقفال السنة المالية', cashier: false, merchant: false, enterprise: true },
      ...
      { name: 'ارصدة حسابات الخزن', cashier: false, merchant: true, enterprise: true },
    ],
  },
];
